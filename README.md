...
Several blinking modes can be cycled through with the touch button: scroll (default, up and down animation), all (all on with sligth twinkle), and pixies (one LED at a time)
